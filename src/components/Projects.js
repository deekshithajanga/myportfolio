...
const Projects = () => {
  ...
  const projects = [
    ...
    },
    {
      ...
      fullDescription: 'A smart lock system designed to provide secure, hands-free operation through voice commands. The system uses IoT hardware modules to process authorized commands, allowing users to lock or unlock doors instantly without physical keys.It supports remote control, offering both convenience and enhanced security for homes or offices, while keeping the setup simple and cost-effective.',
    ...
    },
    {
      ...
      fullDescription: 'A role-based web application built to streamline institutional asset tracking and management. The platform provides dedicated dashboards for Admins, HODs, and Users, enabling smooth request approvals, asset assignments, and returns. It features QR code scanning for instant identification, automated approval workflows, notification management, and detailed asset history logs. ',
